                ...
                <CardContent>
                  <form onSubmit={handleUpdateProfile} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">Contact <a href="mailto:hello@experimentlacrosse.com" className="text-primary hover:underline">support</a> to change your email address.</p>
                    </div>
